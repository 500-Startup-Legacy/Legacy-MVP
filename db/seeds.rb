...
alex1 = User.create(first_name:'alex1', last_name: 'wang', email:'alexwang9499@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287111')
alex2 = User.create(first_name:'alex2', last_name: 'wang', email:'alexwang94999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287110')
alex3 = User.create(first_name:'alex3', last_name: 'wang', email:'alexwang949999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287114')
alex4 = User.create(first_name:'alex4', last_name: 'wang', email:'alexwang94999969@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287115')
alex5 = User.create(first_name:'alex5', last_name: 'wang', email:'alexwang941999999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287116')
alex6 = User.create(first_name:'alex6', last_name: 'wang', email:'alexwang94912399999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287117')
alex7 = User.create(first_name:'alex7', last_name: 'wang', email:'alexwang94991239999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287118')
alex8 = User.create(first_name:'alex8', last_name: 'wang', email:'alexwang9499239999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287119')
alex9 = User.create(first_name:'alex9', last_name: 'wang', email:'alexwang949994999@gmail.com', password: 'foobar', password_confirmation: 'foobar', public:true, phone_number:'7038287103')
...
alex.memories.create(content:'Love this guy!Love this guy!Love this guy!', memorialized_user_id: abraham.id)
alex.memories.create(content:'Love this guy!Love this guy!LovLove tLove this guy!his guy!e this guy!', memorialized_user_id: ed.id)
alex.memories.create(content:'He was a badass mofoLovLove this guy!e this guy!', memorialized_user_id: collin.id)
alex.memories.create(content:'Glad he"s deLove thisLove this guy! guy!ad!', memorialized_user_id: alex1.id)
alex.memories.create(content:'Love this gLove tLove thLove this guy!is guy!his guy!uy!', memorialized_user_id: alex2.id)
alex.memories.create(content:'He owes me moLove thiLove this guy!s guy!ney', memorialized_user_id: alex3.id)
